...
@RestController // this controller is different from the Spring MVC. Used in REST API
@CrossOrigin(origins = "*")
public class ProductController {
	...
	@GetMapping("/products") //must be noun
	public List<Product> getProduct() {
		return productList;
	}
	
	@GetMapping("/products/{id}")
	private Product findProductById(@PathVariable("id") long pid) {
